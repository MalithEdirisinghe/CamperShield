...
const AnimalTracking = () => {
    ...
    const openCamera = async () => {
        ...
        if (!result.canceled) {
            navigation.navigate('MushroomImageSuccess', { imageUri: result.assets[0].uri });
        } else {
    ...
    return (
        <View style={styles.container}>
            ...
            />
            <Text style={styles.topicText}>Flora / Fungi Identification</Text>
            <Text style={styles.normalText}>Capture Flora / Fungi to Identify Poison Or Edible </Text>
